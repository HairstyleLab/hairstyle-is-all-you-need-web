    ...
    if (editIcon && fileInput && previewImg) {
        ...
        fileInput.addEventListener("change", function (event) {
            ...
            if (file) {
                ...
                previewImg.src = previewUrl;   // 🔥 미리보기 즉시 반영
            }
        });
    }
...
function updateUserProfile() {
    ...
    const sidebarImg = document.getElementById('profileImg');        // 사이드바 이미지
    const modalImg = document.getElementById('modalProfileImg');     // 모달 내부 프로필 이미지
